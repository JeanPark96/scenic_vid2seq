...
ACTIVITYNET_TRAIN_SIZE = 1  # Number of videos
...
def get_config(runlocal=''):
  ...
  config.datasets = {'zero_shot_eval': config.dataset_configs}
...
#   epochs = ml_collections.config_dict.FieldReference(20)
  epochs = ml_collections.config_dict.FieldReference(0)
  ...
  # Learning schedule.
  steps_per_epoch = 1 if runlocal else ACTIVITYNET_TRAIN_SIZE // batch_size
